...
class Clip extends React.Component {
  ...
  render() {
    ...
    let node = <img id="clipImage" style={{height: "auto", width: clip.image.dimensions.x + "px", maxWidth: "100%", background: backgroundStyle }} ref="clipImage" src={ clip.image.url } alt={ clip.image.text } />;
